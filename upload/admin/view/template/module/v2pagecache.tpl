...
function showstatus() {
 $( document ).ready(function() {
      $.ajax({
          url: 'index.php?route=module/v2pagecache/jsonstatusindexphp'+
...
function enablemod() {
  $( document ).ready(function() {
      $.ajax({
          url: 'index.php?route=module/v2pagecache/enable'+
               '&token=<?php echo $token; ?>',
                type: 'get',
                dataType: 'json',
                beforeSend: function(){
...
function disablemod() {
  $( document ).ready(function() {
      $.ajax({
          url: 'index.php?route=module/v2pagecache/disable'+
               '&token=<?php echo $token; ?>',
                type: 'get',
                dataType: 'json',
                beforeSend: function(){
...
function fillstats() {
  $( document ).ready(function() {
      $.ajax({
          url: 'index.php?route=module/v2pagecache/stats'+
               '&token=<?php echo $token; ?>',
                type: 'get',
                dataType: 'json',
                success: function(json) {
...
function purge(which) {
    $( document ).ready(function() {
        $.ajax({
            url: 'index.php?route=module/v2pagecache/purge'+
               '&which='+which+
               '&token=<?php echo $token; ?>',
            type: 'get',
            dataType: 'json',
